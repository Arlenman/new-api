...
func InitOptionMap() {
	...
	common.OptionMap["LogSensitiveRequestEnabled"] = strconv.FormatBool(setting.LogSensitiveRequestEnabled)
	...
	common.OptionMap["CustomNavMenus"] = "[]"
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "LogSensitiveRequestEnabled":
			setting.LogSensitiveRequestEnabled = boolValue
