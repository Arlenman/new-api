...
func registerUpstreamChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	upstreamRoute.Use(middleware.RootAuth())
	{
		...
		upstreamRoute.GET("/statistics", controller.GetUpstreamChannelStatistics)
		...
		upstreamRoute.POST("/priority-schedule/run", controller.RunUpstreamPrioritySchedule)
		upstreamRoute.GET("/priority-schedule/tasks", controller.ListUpstreamPriorityScheduleTasks)
		upstreamRoute.DELETE("/priority-schedule/tasks", controller.ClearUpstreamPriorityScheduleTasks)
