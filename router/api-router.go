...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/pixelflow/session-token-sync", middleware.DisableCache(), controller.PixelFlowSessionTokenSync)
		apiRouter.GET("/pixelflow/session-token-sync/data", middleware.DisableCache(), middleware.UserAuth(), controller.PixelFlowSessionTokenSyncData)
		...
		registerAlertRuleRoutes(apiRouter)
		registerAuthzRoutes(apiRouter)
		registerUserToolRoutes(apiRouter)
