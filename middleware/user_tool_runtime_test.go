...
func TestUserToolRuntimeRequestAllowed(t *testing.T) {
	tests := []struct {
		...
		{name: "image task status", tool: model.UserToolImagePlayground, method: http.MethodGet, path: "/pg/image-tasks/uitask_123", want: true},
		{name: "image task nested path", tool: model.UserToolImagePlayground, method: http.MethodGet, path: "/pg/image-tasks/uitask_123/content", want: false},
		{name: "managed image content", tool: model.UserToolImagePlayground, method: http.MethodGet, path: "/pg/image-files/pgf_123/content", want: true},
		{name: "managed image content missing id", tool: model.UserToolImagePlayground, method: http.MethodGet, path: "/pg/image-files//content", want: false},
		{name: "managed image nested path", tool: model.UserToolImagePlayground, method: http.MethodGet, path: "/pg/image-files/pgf_123/content/extra", want: false},
